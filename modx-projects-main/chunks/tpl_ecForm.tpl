<h2>{'ec_fe_message_add' | lexicon}</h2>
<form class="form well ec-form" method="post" role="form" id="ec-form-{$fid}" data-fid="{$fid}" action="" {if $files}formenctype="multipart/form-data"{/if}>
    ...
    <div class="form-group">
        ...
        <input type="text" name="user_name" class="form-control" id="ec-user_name-{$fid}" value="" />
    ...
    <div class="form-group">
        ...
        <textarea name="text" class="form-control" rows="5" id="ec-text-{$fid}">{$text}</textarea>
