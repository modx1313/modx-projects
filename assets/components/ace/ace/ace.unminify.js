(function () {
    ...
    ace.define("ace/lib/dom", ["require", "exports", "module"], function (e, t, n) {
        ...
        (t.getDocumentHead = function (e) {
            ...
            (t.importCssString = function (n, i, s) {
                ...
                i && (n += "\n/*# sourceURL=ace/css/" + i + " */"),
                    s.createStyleSheet
                        ? ((o = s.createStyleSheet()), (o.cssText = n), i && (o.owningElement.id = i))
                        : ((o = s.createElementNS ? s.createElementNS(r, "style") : s.createElement("style")), o.appendChild(s.createTextNode(n)), i && (o.id = i), t.getDocumentHead(s).appendChild(o));
            }),
            ...
            f = function (e, t) {
                ...
                r.addListener(n, "compositionstart", B),
                    ...
                    (this.onContextMenu = function (e) {
                        (L = !0), b(t.selection.isEmpty()), t._emit("nativecontextmenu", { target: t, domEvent: e }), this.moveToMouse(e, !0);
                    }),
            ...
            (this.onMouseDown = function (e) {
                ...
                (this.onTripleClick = function (e) {
                    ...
                    r.isMultiLine() && r.contains(t.row, t.column)
                        ? ((this.$clickSelection = n.selection.getLineRange(r.start.row)), (this.$clickSelection.end = n.selection.getLineRange(r.end.row).end))
    ...
    ace.define(
        ...
        ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop_handler", "ace/config"],
        function (e, t, n) {
            "use strict";
            var r = e("../lib/event"),
                i = e("../lib/useragent"),
                ...
                l = function (e) {
                    ...
                    r.addListener(u, "click", this.onMouseEvent.bind(this, "click")),
                        ...
                        r.addMultiMouseDownListener(u, [400, 300, 250], this, "onMouseEvent"),
                        e.renderer.scrollBarV &&
                            (r.addMultiMouseDownListener(e.renderer.scrollBarV.inner, [400, 300, 250], this, "onMouseEvent"),
                            r.addMultiMouseDownListener(e.renderer.scrollBarH.inner, [400, 300, 250], this, "onMouseEvent"),
                            i.isIE && (r.addListener(e.renderer.scrollBarV.element, "mousedown", n), r.addListener(e.renderer.scrollBarH.element, "mousedown", n))),
        ...
        (function () {
            r.implement(this, s),
                ...
                (this.toOrientedRange = function (e) {
                    var t = this.getRange();
                    return (
                        e ? ((e.start.column = t.start.column), (e.start.row = t.start.row), (e.end.column = t.end.column), (e.end.row = t.end.row)) : (e = t),
                    ...
                    for (var a = 0; a < n.length; a++) {
                        ...
                        Array.isArray(f.token)
                            ? f.token.length == 1 || c == 1
                                ? (f.token = f.token[0])
                                : c - 1 != f.token.length
                                ? (this.reportError("number of classes and regexp groups doesn't match", { rule: f, groupCount: c - 1 }), (f.token = f.token[0]))
            ...
            (this.normalizeRules = function () {
                function i(s) {
                    ...
                    for (var u = 0; u < o.length; u++) {
                        ...
                        !a.regex &&
                            a.start &&
                            ((a.regex = a.start), a.next || (a.next = []), a.next.push({ defaultToken: a.token }, { token: a.token + ".end", regex: a.end || a.start, next: "pop" }), (a.token = a.token + ".start"), (a.push = !0));
                        var f = a.next || a.push;
        ...
        (function () {
            r.implement(this, i),
                ...
                (this.$tokenizeRow = function (e) {
                    ...
                    return (
                        this.states[e] + "" != r.state + "" ? ((this.states[e] = r.state), (this.lines[e + 1] = null), this.currentLine > e + 1 && (this.currentLine = e + 1)) : this.currentLine == e && (this.currentLine = e + 1),
                    ...
                    if (e.sameRow) {
                        ...
                        this.folds.push(e),
                            ...
                            this.range.compareEnd(e.start.row, e.start.column) > 0
                                ...
                                : this.range.compareStart(e.end.row, e.end.column) < 0 && ((this.start.row = e.start.row), (this.start.column = e.start.column));
            ...
            (function () {
                ...
                r.implement(this, o),
                    ...
                    (this.onChange = function (e) {
                        ...
                        !this.$fromUndo && this.$undoManager && !e.ignore && (this.$deltasDoc.push(e), t && t.length != 0 && this.$deltasFold.push({ action: "removeFolds", folds: t }), this.$informUndoManager.schedule()),
                    ...
                    (this.$onChangeMode = function (e, t) {
                        ...
                        this.bgTokenizer.setDocument(this.getDocument()),
                            ...
                            t || (e.attachToSession && e.attachToSession(this), this.$options.wrapMethod.set.call(this, this.$wrapMethod), this.$setFolding(e.foldingRules), this.bgTokenizer.start(0), this._emit("changeMode"));
                    }),
                    ...
                    (this.$getUndoSelection = function (e, t, n) {
                        ...
                        for (var a = 1; a < e.length; a++)
                            (i = e[a]),
                                r(i)
                                    ? ((o = i.start), s.compare(o.row, o.column) == -1 && s.setStart(o), (o = i.end), s.compare(o.row, o.column) == 1 && s.setEnd(o), (u = !0))
                                    : ((o = i.start), s.compare(o.row, o.column) == -1 && (s = f.fromPoints(i.start, i.start)), (u = !1));
                        if (n != null) {
                    ...
                    (this.adjustWrapLimit = function (e, t) {
                        ...
                        return r != this.$wrapLimit && r > 1
                            ? ((this.$wrapLimit = r), (this.$modified = !0), this.$useWrapMode && (this.$updateWrapData(0, this.getLength() - 1), this.$resetRowCache(0), this._signal("changeWrapLimit")), !0)
                            : !1;
                    }),
                    ...
                    (this.$updateInternalDataOnChange = function (e) {
                        ...
                        if (u != 0)
                            if (n === "remove") {
                                ...
                                if (l) {
                                    ...
                                    v == 0 ? ((l = l.split(r.row, r.column)), l && (l.shiftRow(u), l.addRemoveChars(o, 0, i.column - r.column))) : v == -1 && (l.addRemoveChars(s, 0, i.column - r.column), l.shiftRow(u)),
                                        (c = f.indexOf(l) + 1);
                                }
                                for (c; c < f.length; c++) {
                                    var l = f[c];
                        ...
                        return (
                            t && this.$wrapData.length != this.doc.getLength() && console.error("doc.getLength() and $wrapData.length have to be the same!"),
                            (this.$updating = !1),
            ...
            },
            {
                ...
                exec: function (e) {
                    ...
                    i.row + 1 < e.session.doc.getLength() - 1 && (f += e.session.doc.getNewLineCharacter()),
                        ...
                        a > 0 ? (e.selection.moveCursorTo(n.row, n.column), e.selection.selectTo(n.row, n.column + a)) : ((o = e.session.doc.getLine(n.row).length > o ? o + 1 : o), e.selection.moveCursorTo(n.row, o));
                },
                multiSelectAction: "forEach",
                readOnly: !0,
            },
            {
                ...
                exec: function (e) {
                    ...
                    for (var o = 0; o < r.length; o++)
                        o == r.length - 1 && (r[o].end.row !== t || r[o].end.column !== n) && i.push(new s(r[o].end.row, r[o].end.column, t, n)),
                            o === 0 ? (r[o].start.row !== 0 || r[o].start.column !== 0) && i.push(new s(0, 0, r[o].start.row, r[o].start.column)) : i.push(new s(r[o - 1].end.row, r[o - 1].end.column, r[o].start.row, r[o].start.column));
            ...
            (function () {
                r.implement(this, d),
                    ...
                    (this.$highlightTags = function () {
                        ...
                        (this.$highlightTagPending = !0),
                            setTimeout(function () {
                                ...
                                t.$tagHighlight && l.compareRange(t.$backMarkers[t.$tagHighlight].range) !== 0 && (t.removeMarker(t.$tagHighlight), (t.$tagHighlight = null)),
                    ...
                    (this.onCursorChange = function () {
                        this.$cursorChange(),
                            this.$blockScrolling ||
                                (g.warn("Automatically scrolling cursor into view after selection change", "this will be disabled in the next version", "set editor.$blockScrolling = Infinity to disable this message"),
                                this.renderer.scrollCursorIntoView()),
                    ...
                    (this.insert = function (e, t) {
                        ...
                        s &&
                            ...
                            (s.selection.length == 2
                                ? this.selection.setSelectionRange(new p(i.row, f + s.selection[0], i.row, f + s.selection[1]))
                                : this.selection.setSelectionRange(new p(i.row + s.selection[0], s.selection[1], i.row + s.selection[2], s.selection[3])));
                            ...
                            if (h.compare(n.row, n.column) === 0) {
                                ...
                                do
                                    (s = i),
                                        (i = r.stepBackward()),
                                        i &&
                                            (i.type.indexOf("tag-close") !== -1 && h.setEnd(r.getCurrentTokenRow(), r.getCurrentTokenColumn() + 1),
                                            s.value === v && s.type.indexOf("tag-name") !== -1 && (i.value === "<" ? a[v]++ : i.value === "</" && a[v]--, a[v] === 0 && (u = !0)));
                                while (i && !u);
                            }
                            s && s.type.indexOf("tag-name") && ((d = h.start), d.row == n.row && Math.abs(d.column - n.column) < 2 && (d = h.end));
                        }
                        (d = (h && h.cursor) || d),
                            d && (e ? (h && t ? this.selection.setRange(h) : h && h.isEqual(this.getSelectionRange()) ? this.clearSelection() : this.selection.selectTo(d.row, d.column)) : this.selection.moveTo(d.row, d.column));
                    }),
                    ...
                    (this.find = function (e, t, n) {
                        ...
                        t.needle == null &&
                            ((e = this.session.getTextRange(i) || this.$search.$options.needle), e || ((i = this.session.getWordRange(i.start.row, i.start.column)), (e = this.session.getTextRange(i))), this.$search.set({ needle: e })),
                            this.$search.set(t),
                ...
                (this.drawTextMarker = function (t, n, i, s, o) {
                    ...
                    for (; l <= f; l++)
                        (d.start.row = d.end.row = l),
                            ...
                            this.drawSingleLineMarker(t, d, i + (l == a ? " ace_start" : "") + " ace_br" + e(l == a || (l == a + 1 && n.start.column), c < h, h > p, l == f), s, l == f ? 0 : 1, o);
                }),
            ...
            r.implement(this, u),
                ...
                (this.update = function (e) {
                    ...
                    for (;;) {
                        ...
                        if (i > r) break;
                        this.$useLineGroups() && t.push("<div class='ace_line_group' style='height:", e.lineHeight * this.session.getRowLength(i), "px'>"),
                ...
                (this.renderIndentGuide = function (e, t, n) {
                    ...
                    return r <= 0 || r >= n
                        ? t
                        : t[0] == " "
                        ? ((r -= r % this.tabSize), e.push(s.stringRepeat(this.$tabStrings[" "], r / this.tabSize)), t.substr(r))
                        : t[0] == "	"
                ...
                (this.CHANGE_CURSOR = 1),
                    ...
                    (this.$computeLayerConfig = function () {
                        ...
                        this.session.setScrollTop(Math.max(-h.top, Math.min(this.scrollTop, i - t.scrollerHeight + h.bottom))),
                            this.session.setScrollLeft(Math.max(-h.left, Math.min(this.scrollLeft, s + 2 * this.$padding - t.scrollerWidth + h.right)));
                    ...
                    (this.scrollCursorIntoView = function (e, t, n) {
                        ...
                        a + o > s
                            ...
                            : a + this.$size.scrollerHeight - u < s + this.lineHeight && (t && (s += t * this.$size.scrollerHeight), this.session.setScrollTop(s + this.lineHeight - this.$size.scrollerHeight));
            ...
            s.implement(this, i),
                ...
                (this.onUpdate = function (e) {
                    ...
                    if (t.start.column >= this.pos.column && t.start.column <= this.pos.column + this.length + 1) {
                        ...
                        for (var s = 0; s < this.others.length; s++) this.others[s]._emit("change", { value: this.others[s] });
                    }
                    this.$updating = !1;
                }),
            ...
            if (S == "add") {
                ...
                l.$blockScrolling++,
                    ...
                    l.once("mouseup", function () {
                        ...
                        T && e.isEmpty() && s(T.cursor, e.cursor) ? c.substractPoint(e.cursor) : (o ? c.substractPoint(x.cursor) : x && (l.removeSelectionMarker(x), c.addRange(x)), c.addRange(e)),
                            l.$blockScrolling--,
                ...
                (this.updateSelectionMarkers = function () {
                    ...
                    (this.selectMore = function (e, t, n) {
                        ...
                        var o = r.getTextRange(s),
                            u = h(r, o, e);
                        u && ((u.cursor = e == -1 ? u.start : u.end), (this.$blockScrolling += 1), this.session.unfold(u), this.multiSelect.addRange(u), (this.$blockScrolling -= 1), this.renderer.scrollCursorIntoView(null, 0.5)),
